...
export const TAG = 'ChallengeMapScreen';
class ChallengeMapScreen extends BaseScreen {
  constructor(props) {
    super(props);
  ...
  getPaths = () => {
    return  (
      new Path().moveTo(0,0).lineTo(200,200)
    );
  }
  renderMap = () => {
    ...
    return (
      <View style={styles.map}>
        <Surface width={screenSize.width} height={screenSize.height}>
        <Shape
          stroke="black" 
          strokeWidth={2}
          d={this.getPaths()}
...
ChallengeMapScreen.propTypes = {};

ChallengeMapScreen.defaultProps = {};
